...
// let aaa = Object.values(kkk);
// console.log(Object.values(aaa));
// console.log(Object.keys(kkk));

var primerElemento = kkk.categories;
var searchBycategories = document.getElementById("searchBycategories");
var _iteratorNormalCompletion = true;
var _didIteratorError = false;
var _iteratorError = undefined;

try {
  for (var _iterator = primerElemento[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
    var variable = _step.value;
    console.log(variable.strCategory);
    var option = document.createElement("option");
    var sel = searchBycategories.options[searchBycategories.selectedIndex];
    option.text = variable.strCategory;
    searchBycategories.add(option, sel);
  } // Object.keys(kkk).forEach(function (key, index) {
  //   console.log(key);
  //   console.log(index);
  ...
  // console.log(kkk[0].key)
  // newObject = kkk[0].map(function (value, label) {
  //   console.log(value);
  //   console.log(label);
  // });
